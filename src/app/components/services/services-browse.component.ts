            ...
            <div 
              *ngFor="let service of paginatedServices" 
              ...
              <div class="card-header">
                ...
                <div class="service-rate">{{ service.hourlyRate }} hrs</div>
              </div>
              ...
              *ngFor="let service of paginatedServices" 
              ...
              <div class="list-item-content">
                <div class="list-item-header">
                  <h3 class="service-title">{{ service.title }}</h3>
                  <div class="service-rate">{{ service.hourlyRate }} hrs/hour</div>
                </div>
  ...
  sortServices() {
    switch (this.sortBy) {
      ...
      case 'rating':
        ...
        break;
      case 'price-low':
        this.filteredServices.sort((a, b) => a.hourlyRate - b.hourlyRate);
        break;
      case 'price-high':
        this.filteredServices.sort((a, b) => b.hourlyRate - a.hourlyRate);
        break;
      case 'popular':
