...
# Service categories (all services will have hourly rate of 1)
SERVICE_CATEGORIES = {
...
def generate_services_for_user(user_data: Dict[str, Any]) -> List[Dict[str, Any]]:
    """Generate services for a user based on their skills - ALL WITH HOURLY RATE OF 1"""
    services = []
    ...
    for i in range(num_services):
        ...
        services.append({
            ...
            'category': category,
            'hourlyRate': 1.0,  # ALL SERVICES HAVE HOURLY RATE OF 1
            ...
            'tags': [
                ...
                'experienced',
                category.lower(),
                'hourbank-special'  # Special tag to identify these services
            ]
        })
...
def create_realistic_user(user_data: Dict[str, Any]) -> Dict[str, Any]:
    """Create a realistic test user with services (all at $1/hour)"""
    try:
        ...
        # Create services (all at $1/hour)
        print("  🛠️  Creating services (all at $1.00/hour)...")
        ...
        for service_data in services_to_create:
            try:
                ...
                print(f"    ✅ Service created: {service_data['title']} ($1.00/hour)")
...
def create_realistic_test_users(count: int = 10) -> Dict[str, Any]:
    """Create multiple realistic test users with $1/hour services"""
    print(f"🚀 Creating {count} realistic test users (all services at $1.00/hour)...\n")
    ...
    if results['successful']:
        print("\n✅ SUCCESSFUL USERS (All services at $1.00/hour):")
        total_services = 0
        for i, result in enumerate(results['successful'], 1):
            ...
            print(f"   Services: {service_count} (all at $1.00/hour)")
        ...
        print(f"   All Services Rate: $1.00/hour")
        print(f"   This ensures fair and equal pricing across the platform!")
...
def main():
    ...
    try:
        ...
        print("💰 Realistic Test Users Creator (All Services at $1.00/hour)")
        print("=" * 60)
        ...
        print("💰 All services are priced at $1.00/hour for fair and equal access!")
        ...
        if results['successful']:
            ...
            print(f"💵 Service Rate: $1.00/hour (ALL SERVICES)")
